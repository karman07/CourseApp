							...
							<div className='items-center justify-center w-full mt-12 mb-4 lg:flex'>
								<div className='flex flex-col items-start justify-start w-full h-auto mb-12 lg:w-1/3 lg:mb-0'>
									...
									<blockquote className='mt-8 text-lg text-gray-500'>
										"This is a no-brainer if you want to
										take your business to the next level. If
										you are looking for the ultimate
										toolset, this is it!"
									</blockquote>
								</div>
								<div className='flex flex-col items-start justify-start w-full h-auto px-0 mx-0 mb-12 border-l border-r border-transparent lg:w-1/3 lg:mb-0 lg:px-8 lg:mx-8 lg:border-gray-200'>
									...
									<blockquote className='mt-8 text-lg text-gray-500'>
										"Thanks for creating this service. My
										life is so much easier. Thanks for
								...
								<div className='flex flex-col items-start justify-start w-full h-auto lg:w-1/3'>
									...
									<blockquote className='mt-8 text-lg text-gray-500'>
										"Packed with awesome content and exactly
										what I was looking for. I would highly
